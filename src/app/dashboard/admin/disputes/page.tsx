...
export default function AdminDisputesPage() {
    const { disputes, isLoading, error, updateDisputeStatus } = useAdminDisputes();
            ...
            <Grid container spacing={3} sx={{ mb: 3 }}>
                <Grid size={{ xs: 12, sm: 4 }}>
                    <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 2, border: '1px solid #eaeaea', boxShadow: 'none' }}>
                        ...
                        <Typography variant="h3" color="primary" sx={{ mt: 1, fontWeight: 'bold' }}>{disputes.length}</Typography>
                    </Paper>
                </Grid>
                <Grid size={{ xs: 12, sm: 4 }}>
                    <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 2, border: '1px solid #eaeaea', boxShadow: 'none' }}>
